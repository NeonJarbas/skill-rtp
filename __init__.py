...
class RTPSkill(OVOSCommonPlaybackSkill):
    def __init__(self, *args, **kwargs):
        ...
        self.channels = {
            ...
            "rtp2": {"name": "RTP2", "img": "3-363718101410.png"},
            "rtp3": {"name": "RTP3", "img": "64-393818101410.png"},
            "rtpinternacional": {"name": "RTP Internacional", "img": "120-344318101410.png"},
            "rtpmemoria": {"name": "RTP Memoria", "img": "80-584819141705.png"},
            "rtpmadeira": {"name": "RTP Madeira", "img": "107-443519141305.png"},
    ...
    def featured_media(self):
        return [{
            ...
            "bg_image": f'https://cdn-images.rtp.pt/common/img/channels/logos/color/horizontal/{ch["img"]}',
